    ...
    <View>
      ...
      <View style={[styles.card, styles.cardElevated]}>
        ...
        <View style={styles.cardBody}>
            <Text style={styles.cardTitle}>Mor Pankh </Text>
            <Text style={styles.cardLabel}> green color </Text>
            <Text style={styles.discriptions}>  this picture about only mor pank and is is no bautiful ! </Text>
